    ...
    Umbraco.System.UmbracoApplication = Base.extend({
        ...
        constructor: function (o) {
            ...
            this._opts.contentFrame.load(function() {
                _this._opts.editorContainer.fadeIn();
            });
        ...
        refreshAppTray: function() {
            ...
            $("#trayContainer").fadeOut(300, function() {
                $("#trayContainer").load(_this._opts.appTrayUrl, function() {
        ...
        switchApp: function(appAlias) {
            ...
            this._opts.mainTree.loadApp(src, function(data) {
                ...
                if (persistedTreeData && persistedTreeData.selectedNodes && persistedTreeData.selectedNodes.length > 0) {
        ...
        handleAjaxException: function(x, t, e) {
            ...
            if (this.detectLoginPage(x.responseText)) {
                ...
                Umbraco.System.WindowManager.getInstance().showModal({ isGlobal: true, title: "Server error", modalType: "exception", forceContentInIFrame: true, content: x.responseText });
            }
        }
